...
public class IdentityData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public IdentityData(java.lang.String userId, java.lang.String appSessionId, java.lang.String timestamp, java.lang.String action, java.lang.String sessionId, java.util.Map<java.lang.String,java.lang.String> properties) {
    this.userId = userId;
  ...
  /**
   * Creates a new IdentityData RecordBuilder.
   * @return A new IdentityData RecordBuilder
   */
  public static com.iot.data.schema.IdentityData.Builder newBuilder() {
    return new com.iot.data.schema.IdentityData.Builder();
  }

  /**
   * Creates a new IdentityData RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new IdentityData RecordBuilder
   */
  public static com.iot.data.schema.IdentityData.Builder newBuilder(com.iot.data.schema.IdentityData.Builder other) {
    return new com.iot.data.schema.IdentityData.Builder(other);
  }

  /**
   * Creates a new IdentityData RecordBuilder by copying an existing IdentityData instance.
   * @param other The existing instance to copy.
   * @return A new IdentityData RecordBuilder
   */
  public static com.iot.data.schema.IdentityData.Builder newBuilder(com.iot.data.schema.IdentityData other) {
    return new com.iot.data.schema.IdentityData.Builder(other);
  }

  /**
   * RecordBuilder for IdentityData instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<IdentityData>
    implements org.apache.avro.data.RecordBuilder<IdentityData> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.iot.data.schema.IdentityData.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing IdentityData instance
     * @param other The existing instance to copy.
     */
    private Builder(com.iot.data.schema.IdentityData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder setUserId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder clearUserId() {
      userId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder setAppSessionId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder clearAppSessionId() {
      appSessionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder setTimestamp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder setAction(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder clearAction() {
      action = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder setSessionId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder clearSessionId() {
      sessionId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder setProperties(java.util.Map<java.lang.String,java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.iot.data.schema.IdentityData.Builder clearProperties() {
      properties = null;
    ...
    public IdentityData build() {
      try {
        IdentityData record = new IdentityData();
